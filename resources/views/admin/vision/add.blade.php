                            ...
                            <div class="row mb-4">
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" class="form-control" name="title" id="title"
                                        placeholder="Title" required value="{{ $vision->title ?? '' }}">
                                </div>
                                <div class="form-group col-md-12">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <img src="{{ @helper::image_path($vision->image) }}" alt="" class="img-fluid hw-50 rounded mt-2">
                                </div>
                            </div>
                            <div class="text-end">
                                <a href="{{ route('admin.vision.add') }}" class="btn btn-danger">Cancel</a>
