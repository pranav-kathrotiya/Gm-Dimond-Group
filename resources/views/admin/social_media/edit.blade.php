            ...
            <div class="col-12">
                <div class="card border-0">
                    <div class="card-body box-shadow">
                        <form action="{{ route('admin.social_media.update', $social_media->id) }}" method="post"
                            ...
                            <div class="row mb-4">
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" class="form-control" name="link" id="link" placeholder="Link" value="{{ $social_media->link }}" required>
                                </div>
                                <div class="form-group col-md-12">
                                    ...
                                    <img src="{{ @helper::image_path($social_media->image) }}" alt=""
